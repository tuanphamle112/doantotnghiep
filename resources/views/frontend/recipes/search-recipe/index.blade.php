...
<div class="wrap clearfix">
    ...
    <div class="row">
        <header class="s-title">
            <h1>{{ __('Search Recipes') }}</h1>
        </header>
        <section class="content full-width">
            <nav class="tabs">
                <ul>
                    <li class="nav-search active"><a data-tab="tab1" title="Search by ingredients">Search by ingredients</a></li>
            ...
            <div class="tab-content" id="tab1" style="display: block;">
                <div class="center">
                    ...
                    <form method="post" action="{{ route('search.ingredient') }}">
                        {{ csrf_field() }}
                        <div class="f-row">
                            <input id="ingredient_name" name="ingredient_name" type="text" placeholder="{{ __('Ingredient name here') }}"><ul class="suggest-results"></ul>
                        </div>
                        <div class="f-row">
            ...
            <div class="center">
                    ...
                    <form method="post" action="{{ route('search.recipe') }}">
                        {{ csrf_field() }}
                        <div class="f-row">
                            <input id="recipe_name" name="recipe_name" type="text" placeholder="{{ __('Recipe information here') }}"><ul class="suggest-results"></ul>
                        </div>
                        <div class="f-row">
                            <input type="submit" value="Search">
                        </div>
